...
const TRANSLATIONS: Record<string, Record<string, string>> = {
    mancare: {
        RO: "Alege limba pentru meniul complet de mâncare",
        EN: "Choose the language for the full food menu",
        DE: "Wählen Sie die Sprache für das komplette Speisemenü",
        FR: "Choisissez la langue pour le menu de nourriture",
        ES: "Elige el idioma para el menú de comida",
        IT: "Scegli la lingua per il menu di cibo",
        HU: "Válassza ki a teljes étel menü nyelvét",
    },
    bauturi: {
        RO: "Alege limba pentru meniul complet de băuturi",
        EN: "Choose the language for the full drinks menu",
        DE: "Wählen Sie die Sprache für das komplette Getränkemenü",
        FR: "Choisissez la langue pour le menu des boissons",
        ES: "Elige el idioma para el menú de bebidas",
        IT: "Scegli la lingua per il menu delle bevande",
        HU: "Válassza ki a teljes ital menü nyelvét",
    },
    vinuri: {
        RO: "Alege limba pentru meniul complet de vinuri",
        EN: "Choose the language for the full wines menu",
        DE: "Wählen Sie die Sprache für das komplette Weinmenü",
        FR: "Choisissez la langue pour le menu des vins",
        ES: "Elige el idioma para el menú de vinos",
        IT: "Scegli la lingua per il menu dei vini",
        HU: "Válassza ki a teljes bor menü nyelvét",
    }
}

const TITLE_TRANSLATIONS: Record<string, Record<string, string>> = {
    mancare: {
        RO: "MENIU COMPLET MÂNCĂRE",
        EN: "FULL FOOD MENU",
        DE: "KOMPLETTES SPEISEMENÜ",
        FR: "MENU COMPLET NOURRITURE",
        ES: "MENÚ COMPLETO DE COMIDA",
        IT: "MENU COMPLETO CIBO",
        HU: "TELJES ÉTEL MENÜ",
    },
    bauturi: {
        RO: "MENIU COMPLET BĂUTURI",
        EN: "FULL DRINKS MENU",
        DE: "KOMPLETTES GETRÄNKEMENÜ",
        FR: "MENU COMPLET BOISSONS",
        ES: "MENÚ COMPLETO DE BEBIDAS",
        IT: "MENU COMPLETO BEVANDE",
        HU: "TELJES ITAL MENÜ",
    },
    vinuri: {
        RO: "MENIU COMPLET VINURI",
        EN: "FULL WINES MENU",
        DE: "KOMPLETTES WEINMENÜ",
        FR: "MENU COMPLET VINS",
        ES: "MENÚ COMPLETO DE VINOS",
        IT: "MENU COMPLETO VINI",
        HU: "TELJES BOR MENÜ",
    }
}
...
function MenuLanguageSelector({ categoryGroup }: { categoryGroup: "mancare" | "bauturi" | "vinuri" }) {
            ...
            <div className="flex flex-col items-center gap-6 md:gap-8 bg-slate-50/50 dark:bg-white/5 p-6 md:p-12 rounded-[30px] md:rounded-[40px] border border-slate-100 dark:border-white/10 shadow-xl md:shadow-2xl shadow-slate-200/50 dark:shadow-none max-w-[90vw] md:maxw-3xl w-full">
                <div className="flex items-center justify-center text-primary opacity-80 mb-1 md:mb-2 relative min-h-[30px] md:min-h-[36px] overflow-hidden w-full">
                    <AnimatePresence mode="wait">
                        ...
                        >
                            {TITLE_TRANSLATIONS[categoryGroup][displayLang] || TITLE_TRANSLATIONS[categoryGroup]["EN"]}
                        </motion.span>
                    </AnimatePresence>
                </div>
                ...
                <div className="flex flex-wrap items-center justify-center gap-4 md:gap-8">
                    {[
                        ...
                        <a
                            key={lang.code}
                            href={`/meniu/complet/${categoryGroup}/${lang.code.toLowerCase()}`}
                ...
                <div className="mt-2 md:mt-4 pt-6 md:pt-8 border-t border-slate-200 dark:border-white/10 w-full px-2 overflow-hidden relative min-h-[50px] flex items-center justify-center">
                    <AnimatePresence mode="wait">
                        ...
                        >
                            {TRANSLATIONS[categoryGroup][displayLang] || TRANSLATIONS[categoryGroup]["EN"]}
                        </motion.span>
                    </AnimatePresence>
                </div>
            </div>
...
export function MenuContent() {
    ...
    return (
        <div className="w-full">
            ...
            <MenuLanguageSelector categoryGroup={activeTab === "bauturi" ? "bauturi" : activeTab === "vinuri" ? "vinuri" : "mancare"} />
        </div>
    )
}
