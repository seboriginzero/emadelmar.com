...
export const MENU_ITEMS = [
    { label: "Acasă", href: "https://emadelmar.originzero.art/" },
    { label: "Despre Noi", href: "https://emadelmar.originzero.art/despre-noi" },
    { label: "Meniu", href: "https://emadelmar.originzero.art/meniu" },
    { label: "Evenimente", href: "/evenimente" },
    { label: "P&C", href: "https://emadelmar.originzero.art/parteneri-clienti" },
    { label: "Galerie Foto", href: "https://emadelmar.originzero.art/galerie" },
    { label: "Blog", href: "https://emadelmar.originzero.art/blog" },
    { label: "Contact", href: "https://emadelmar.originzero.art/contact" },
];
...
export const EVENTS_DATA = {
    ...
    types: [
        ...
        },
        {
            ...
            image: "/2026/1-mai/images/1-mai-party-hero.jpg",
            type: "wine",
            premiumMedia: {
                carousel: [
                    "/2026/1-mai/images/1-mai-party-hero.jpg",
                    "/2026/1-mai/images/1-mai-book-table.jpg",
                    "/2026/1-mai/images/1-mai-cocktail-party.jpg"
                ],
                video: "/2026/1-mai/video/1-mai-premium-promo.mp4"
            }
        }
    ],
    cta: {
