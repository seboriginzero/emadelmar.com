                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
                    ...
                    <div className="flex flex-col gap-4 items-center md:items-start">
                        ...
                        <div className="flex gap-4">
                            <a href={SITE_CONFIG.socials.facebook} target="_blank" rel="noopener noreferrer" className="p-2 border rounded-full hover:bg-primary hover:text-primary-foreground transition-all">
                                <Facebook className="h-5 w-5" />
                                <span className="sr-only">Facebook</span>
                            </a>
                            <a  href={SITE_CONFIG.socials.instagram} target="_blank" rel="noopener noreferrer" className="p-2 border rounded-full hover:bg-primary hover:text-primary-foreground transition-all">
                        ...
                        <div className="mt-6 flex flex-col gap-2 items-center md:items-start">
                            ...
                            <a  href={SITE_CONFIG.socials.tripadvisor} target="_blank" rel="noopener noreferrer" className="inline-block hover:opacity-80 transition-opacity">
